...
class ContextAgent(BaseAgent):
    ...
    def __init__(self, agent_id: str = "context_agent", agent_system=None):
        capabilities = [
            AgentCapability(
        ...
        agent_config = config_manager.get_agent_config(AgentType.CONTEXT)
        capabilities = agent_config.get('capabilities', [])
        super().__init__(agent_id, "context", capabilities, agent_system)
        performance_config = config_manager.get_agent_performance_config(AgentType.CONTEXT)
